...
For a second example consider a function similar to \textit{isShort}.
\begin{verbatim}
  f (x:xs) (y:ys) = False
  f xs ys         = True
\end{verbatim}

Its translation to \lambdaPMC.
\[ 
  f = \lazyPMC 
\]
An example execution of $\app{\app{f}{nil}}{\app{tail}{nil}}$ in figure \ref{fig:ex-lazy}.
...
\begin{figure*}
  \[
    \begin{array}{llll}
      ...
      \Gamma[l1\mapsto\tailNil] & \eval{\lazyPMC}                                         & nil                    & (\smallrule{App2})     \\
...
If the arguments were switched around then execution would get stuck.
